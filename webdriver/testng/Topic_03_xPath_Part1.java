...
public class Topic_03_xPath_Part1 {
	...
	public void TC_05_LoginWithValidEmailAndPassword() {
		...
		Assert.assertTrue(driver.findElement(By.xpath("//div[@class='dashboard']//h1[text()='My Dashboard']")).isDisplayed());
	...
	public void TC_06_CreateNewAccount() {
		...
		int emailTail = 5 + rand.nextInt(2);
		...
		Assert.assertTrue(driver.findElement(By.xpath("//span[contains(text(),'Thank you for registering')]")).isDisplayed());
